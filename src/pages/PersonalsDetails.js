...
import { getPersonalDetails, UpsertgetPersonalDetails,
  getPersonalIndivisualDetails, getSinglePersonalsDetails } from '../api';
...
function PersonalDetails() {
  ...
  const getPersonalData = () => {
    ...
    // debugger;
    getSinglePersonalsDetails(id).then(res => {
      if (res && res.data) {
