...
import { getChatSupport } from '../api';
...
function CustomerProfile() {
  ...
  const handleSubmit = (event) => {
    ...
    const data = {
         ...
         name : state.name,
         remark: state.remark,
         supporttype: state.supporttype,reqstatus
        : state.reqstatus,
        amountstatus: state.amountstatus,
        receivedby: state.receivedby,
        createda: state.createda,
    ...
    },
    {
...

      {
        ...
        selector : (row) => <div className='row'>
          ...
          onClick={() => eyehandle()} ><i className='fa fa-eye'></i></div> </div>,
        sortable:true
      }, 
                ...
                <div className="col-12">
                  <div className="card">
                    ...
                    <div className="card-header">
                      <h4 className="card-title">Customer Chat Supports</h4>
                      <Modal show={show} onHide={() => setShow(false)}>
                        <Modal.Header closeButton>
                          <Modal.Title> Modify Customer Chat supports</Modal.Title>
                        </Modal.Header>
                        <Modal.Body> 
                           <form>
                           <div className="mb-3">
