                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-3 col-sm-6">
                            <div className="card overflow-hidden">
                                <div className="card-header align-items-start border-0 pb-0">
                                    <div className="me-auto">
                                        <p className="mb-2 fs-13"><i className="fa fa-caret-down scale5 me-2 text-danger"
                                            aria-hidden="true"></i>Business</p>
                                        <h2 className="text-black mb-0 font-w600">$65,123</h2>
                                    </div>
                                    <svg width="42" height="42" viewBox="0 0 42 42" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="testimonial-one px-4 owl-right-nav owl-carousel owl-loaded owl-drag">
                                                <div className="items">
                                                    <div className="text-center">
                                                        <img className="mb-3 rounded" src="assets/images/contacts/1.jpg" alt="image" />
                                                ...
                                                <div className="items">
                                                    <div className="text-center">
                                                        <img className="mb-3 rounded" src="assets/images/contacts/2.jpg" alt="image" />
                                                ...
                                                <div className="items">
                                                    <div className="text-center">
                                                        <img className="mb-3 rounded" src="assets/images/contacts/3.jpg" alt="image" />
                                                ...
                                                <div className="items">
                                                    <div className="text-center">
                                                        <img className="mb-3 rounded" src="assets/images/contacts/4.jpg" alt="image" />
                                                ...
                                                <div className="items">
                                                    <div className="text-center">
                                                        <img className="mb-3 rounded" src="assets/images/contacts/5.jpg" alt="image" />
