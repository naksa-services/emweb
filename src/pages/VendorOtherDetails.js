...
import { getVendorOtherDetails } from '../api';

import DataTable from 'react-data-table-component';
import LoadingIndicator from './External/LoadingIndicator';

function VendorOtherDetails() {
  ...
  const getPersonalData =() =>{
    // debugger;
    getVendorOtherDetails().then(res => {
        if(res && res.data){
  ...
  const column =[
    {
        ...
        selector : (row) => row.anyotherplatform,
        sortable:true
      },
      {
        name:"Primary Skills",
